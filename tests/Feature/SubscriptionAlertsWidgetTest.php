...
class SubscriptionAlertsWidgetTest extends TestCase
{
    ...
    public function widget_data_returns_correct_structure()
    {
        ...
        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Collection::class, $data["expired"]);
        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Collection::class, $data["expiring_soon"]);
        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Collection::class, $data["suspended"]);
        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Collection::class, $data["cancelled"]);
        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Collection::class, $data["no_subscription"]);
