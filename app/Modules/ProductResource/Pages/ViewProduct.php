                            ...
                            ->schema([
                                ...
                                Components\TextEntry::make('margin')
                                    ...
                                    ->color(function () use ($product) {
                                        if (!$product->cost_price || $product->cost_price <= 0) return 'gray';
                                        $margin = (($product->price - $product->cost_price) / $product->price) * 100;
                            ...
                            ->schema([
                                ...
                                Components\TextEntry::make('days_of_stock')
                                    ...
                                    ->state(function () use ($stats) {
                                        if ($stats['avg_daily_sales'] <= 0) return 'N/D';
                            ...
                            ->schema([
                                ...
                                Components\TextEntry::make('last_entry_date')
                                    ...
                                    ->state(function () use ($product) {
                                        ...
                                        if (!$entry) return 'Sin entradas registradas';
                ...
                Components\Section::make('⏰ Cuándo se Vende Más')
                    ...
                    ->schema([
                        Components\Grid::make(2)
                            ->schema([
                                Components\TextEntry::make('best_selling_day')
                                    ...
                                    ->state(function () use ($stats) {
                                        if (empty($stats['best_day'])) return 'Sin datos';
                                        $days = [
                                            'Monday' => 'Lunes',
                                            'Tuesday' => 'Martes',
                                            'Wednesday' => 'Miércoles',
                                ...
                                Components\TextEntry::make('best_selling_hour')
                                    ...
                                    ->state(function () use ($stats) {
                                        if (empty($stats['best_hour'])) return 'Sin datos';
                        ...
                        Components\TextEntry::make('selling_pattern')
                            ...
                            ->state(function () use ($stats, $product) {
                            ...
                            ->color(function () use ($stats) {
                                ...
                                if ($daysInInventory < 7) return 'info';
                                
                                // Sin ventas en rojo
                                if ($stats['total_sold'] == 0) return 'danger';
                                
                                // Por velocidad de venta
                                if ($stats['sales_velocity'] >= 5) return 'success';
                                if ($stats['sales_velocity'] >= 2) return 'primary';
                                if ($stats['avg_daily_sales'] >= 0.3) return 'warning';
                                return 'danger';
                            }),
                    ]),
