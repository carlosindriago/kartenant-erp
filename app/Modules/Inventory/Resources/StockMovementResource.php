...
class StockMovementResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Modules\Inventory\Resources\StockMovementResource\Pages\ListStockMovements::route('/'),
            'view' => \App\Modules\Inventory\Resources\StockMovementResource\Pages\StockMovementSummary::route('/{record}'),
            'create-entry' => \App\Modules\Inventory\Resources\StockMovementResource\Pages\CreateStockEntry::route('/entry/create'),
            'create-exit' => \App\Modules\Inventory\Resources\StockMovementResource\Pages\CreateStockExit::route('/exit/create'),
        ];
    }
