...
use App\Filament\App\Pages\POS\CloseCashRegisterPage;
use App\Filament\App\Pages\POS\OpenCashRegisterPage;
    ...
    protected function getHeaderActions(): array
    {
        ...
        return [
            Actions\Action::make('open_register')
                ...
                ->color('success')
                ->url(OpenCashRegisterPage::getUrl())
                ->visible(fn () => $userId && ! CashRegister::userHasOpenRegister($userId)),
            ...
            Actions\Action::make('close_register')
                ...
                ->iconPosition(IconPosition::Before)
                ->color('danger')
                ->url(CloseCashRegisterPage::getUrl())
                ->visible(fn () => $userId && CashRegister::userHasOpenRegister($userId)),
        ];
    }
