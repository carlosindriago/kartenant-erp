...
<head>
    <meta charset="utf-8">
    <title>Alta de Empleado - {{ $user->name }}</title>
    <style>
...
<body>
    <div class="header">
        ...
        @endif
        <div class="document-title">✅ ALTA DE EMPLEADO</div>
    ...
    <div class="info-box">
        <div class="section-title">🎭 ROLES ASIGNADOS</div>
        @foreach($user->roles as $role)
        <div class="info-row">
            <div class="info-label">Rol:</div>
            <div class="info-value" style="font-weight: 600; color: #3498db;">{{ $role->name }}</div>
        </div>
        @endforeach
    </div>
    @endif
    ...
    <div class="info-box">
        <div class="section-title">👤 REGISTRO REALIZADO POR</div>
        <div class="info-row">
    ...
    <div class="official-seal">
        ...
        <div style="font-size: 7pt; color: #856404;">
            Este documento certifica el alta del empleado en el sistema<br>
